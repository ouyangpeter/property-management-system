    ...
    function delrow() {
        $.messager.confirm('Confirm', '你确定要删除?', function (r) {
            if (r) {
                ...
                vac.ajax(URL + '/deleteNotice', {Id: row.Id}, 'POST', function (r) {
                    if (r.status) {
                        $("#datagrid").datagrid('reload');
                    } else {
                        vac.alert(r.info);
...
<div id="dialog" title="添加公告" style="width:400px;height:300px;">
    <div style="padding:20px 20px 40px 80px;">
        <form id="form1" method="post">
            <table>
                ...
                <tr>
                    <td>内容：</td>
                    <td><textarea name="Content" style="height: 100px;" class="easyui-validatebox" validType="length[0,500]" required="true"></textarea></td>
                </tr>
            </table>
        </form>
    </div>
