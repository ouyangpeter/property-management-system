...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#datagrid").datagrid({
            ...
            columns: [[
                ...
                {field: 'Criterion', title: '标准', width: 30, align: 'center', editor: 'text', sortable: true},
            ...
            onAfterEdit: function (index, data, changes) {
                ...
                changes.Id = data.Id;
                vac.ajax(URL + '/updateChargeType', changes, 'POST', function (r) {
                    if (!r.status) {
                        vac.alert(r.info);
                    } else {
    ...
    function delrow() {
        $.messager.confirm('Confirm', '你确定要删除?', function (r) {
            if (r) {
                ...
                vac.ajax(URL + '/deleteChargeType', {Id: row.Id}, 'POST', function (r) {
                    if (r.status) {
                        $("#datagrid").datagrid('reload');
                    } else {
                        vac.alert(r.info);
    ...
    function Query() {
        ...
        if ($('#query_criterion').val() != '') {
            postData.criterion = $('#query_criterion').val();
        }
    ...
    <div data-options="region:'north'" style="margin: 2px; height: 60px;">
        ...
        <div data-options="region:'north',split:true,title:'查询条件'" style="padding: 2px;"
            ...
            <table cellpadding="3" cellspacing="3">
                ...
                <tr>
                    <td>收费名称:</td>
                    <td><input type="text" id="query_name" value="" size="10"></td>
                    <td>收费标准:</td>
                    <td><input type="text" id="query_criterion" value="" size="10"
...
<div id="dialog" title="添加收费类型" style="width:400px;height:400px;">
    <div style="padding:20px 20px 40px 80px;">
        <form id="form1" method="post">
            <table>
                ...
                <tr>
                    <td>收费标准：</td>
                    <td><input name="Criterion" class="easyui-validatebox" required="true"/></td>
                </tr>
                <tr>
                    <td>备注：</td>
