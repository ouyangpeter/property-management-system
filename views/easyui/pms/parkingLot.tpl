...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#datagrid").datagrid({
            ...
            columns: [[
                ...
                {field: 'ParkingSpotNum', title: '车位数量', width: 30, align: 'right', editor: 'numberbox', sortable: true},
            ...
            onAfterEdit: function (index, data, changes) {
                ...
                changes.Id = data.Id;
                vac.ajax(URL + '/updateParkingLot', changes, 'POST', function (r) {
                    if (!r.status) {
                        vac.alert(r.info);
                    } else {
    ...
    function delrow() {
        $.messager.confirm('Confirm', '你确定要删除?', function (r) {
            if (r) {
                ...
                vac.ajax(URL + '/deleteParkingLot', {Id: row.Id}, 'POST', function (r) {
                    if (r.status) {
                        $("#datagrid").datagrid('reload');
                    } else {
                        vac.alert(r.info);
    ...
    function Query() {
        ...
        if ($('#query_parking_spot_num').val() != '') {
            postData.parking_spot_num= $('#query_parking_spot_num').val();
        }
        if ($('#query_area').val() != '') {
        ...
        <div data-options="region:'north',split:true,title:'查询条件'" style="padding: 2px;"
            ...
            <table cellpadding="3" cellspacing="3">
                ...
                <tr>
                    ...
                    <td>车位数量:</td>
                    <td><input type="text" id="query_parking_spot_num" value="" size="10"></td>
                    <td>面积:</td>
...
<div id="dialog" title="添加停车场" style="width:400px;height:300px;">
    <div style="padding:20px 20px 40px 80px;">
        <form id="form1" method="post">
            <table>
                ...
                <tr>
                    <td>车位数量：</td>
                    <td><input name="ParkingSpotNum" class="easyui-validatebox" required="true"/></td>
                </tr>
                <tr>
                    <td>面积：</td>
